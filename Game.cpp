...
void Game::initWindow()
{
	...
	this->window = new sf::RenderWindow(this->videoMode, "Marethyu", sf::Style::Titlebar | sf::Style::Close | sf::Style::Resize);
...
void Game::spawnEnemy()
{
	...
	*/
	...
	this->enemy.setPosition(
		// static_cast<name type>, safety convert to <name type>
		//static_cast<float>(rand() % static_cast<int>(this->window->getSize().x - this->enemy.getSize().x)),
		0.f,
		static_cast<float>(rand() % static_cast<int>(this->window->getSize().y - this->enemy.getSize().y))
		// usually not for y, we will some time want to the top
	...
	*/
	...
	if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) {
		if (this->mouseHeld == false) {
			this->mouseHeld = true;
			if (sf::Mouse::isButtonPressed(sf::Mouse::Left)) { // the mouseheld make sure you not keep the click
				bool deleted = false;
...
void Game::render() // see thing change
{
	/*
		@return void
	...
	*/
	...
	this->renderText(*this->window); // this is good for render text last 
